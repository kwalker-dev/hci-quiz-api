CREATE TABLE USERS (USER_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
...
CREATE TABLE OPTIONS (OPTION_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
                        QUESTION_ID BIGINT,
...
CREATE TABLE QUESTIONS (QUESTION_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
                    QUIZ_ID BIGINT,
...
CREATE TABLE QUIZ (QUIZ_ID BIGINT GENERATED ALWAYS AS IDENTITY NOT NULL,
                        USER_ID BIGINT,
